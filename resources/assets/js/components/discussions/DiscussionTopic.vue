            ...
            <div class="media d-block d-md-flex">
                <div v-if="discussion.author" class="d-flex flex-column mb-3 mb-md-0">
                    ...
                    <div class="text-center align-self-bottom">
                        <a href="#" class="btn btn-sm btn-outline-secondary" @click.prevent="isEditingMode = !isEditingMode">
        ...
        methods: {
            ...
            deleteRecord() {
                swal({
                    ...
                    text: "Are you sure you want to delete this discussion?  You will not be able to revert this action!",
                    type: "warning",
